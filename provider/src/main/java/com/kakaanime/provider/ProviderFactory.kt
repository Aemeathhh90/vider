...
object ProviderFactory {
    fun createRegistry(browserResolver: BrowserStreamResolver? = null): ProviderRegistry {
        return ProviderRegistry().apply {
            ...
            register(RemoteSourceProviderV2("zoronime", "Zoronime", 50, "zoronime"))
            register(RemoteSourceProviderV2("anoboy", "Anoboy", 60, "anoboy"))
            register(RemoteSourceProviderV2("animekompi", "AnimeKompi", 70, "animekompi"))
            register(RemoteSourceProviderV2("kuronime", "Kuronime", 80, "kuronime"))
            ...
            register(RemoteSourceProviderV2("oploverz", "Oploverz", 200, "oploverz"))
