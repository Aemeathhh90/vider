...
object ProviderPlaybackResolver {
    ...
    suspend fun episodes(title: String, seasonNumber: Int? = null, seasonTitle: String? = null): List<ProviderEpisode> {
        val candidates = findCandidates(title, seasonNumber, seasonTitle)
    ...
    private suspend fun findCandidates(title: String, seasonNumber: Int?, seasonTitle: String?): List<ProviderAnime> {
